const { SlashCommandBuilder, CommandInteraction, ButtonBuilder, ButtonStyle, ActionRowBuilder } = require('discord.js');
const { avatar } = require('../../../5-embeds/command-embeds');
...
module.exports = {
	...
	async execute(interaction) {
        ...
        let member = user ? interaction.guild.members.cache.get(user.id) : interaction.member;
        if(!member) {
